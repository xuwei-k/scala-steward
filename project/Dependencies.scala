...
object Dependencies {
  val bcprovJdk15to18 = "org.bouncycastle" % "bcprov-jdk15to18" % "1.85.2"
  ...
  val http4sCore = "org.http4s" %% "http4s-core" % "1.0.0-M48"
  ...
  val millMain = "com.lihaoyi" % "mill-runner-launcher_3" % "1.1.8"
  ...
  val munitScalacheck = "org.scalameta" %% "munit-scalacheck" % "1.3.1"
